...
<head>
  <meta charset="utf-8" />
  <title>Zoo Arcadia - Horaires</title>
      ...
      <div class="navbar-nav ms-auto">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu rounded-0 rounded-bottom m-0">
            ...
            <a href="visiting.php" class="dropdown-item active">Heures de Visite</a>
          </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                ...
                <ul class="list-group list-group-flush">
                    <?php
                    // Inclure le fichier de connexion à la base de données et récupérer les horaires
                    require_once('../back-end/config/db_connect.php');

                    try {
                        // Récupérer une instance de PDO sécurisée
                        $pdo = getPDO();

                        // Requête SQL pour récupérer tous les horaires
                        ...
                        foreach ($horaires as $horaire) {
                            ...
                            echo '<span>' . htmlspecialchars($horaire['jour_semaine']) . '</span>';
                            echo '<span>' . htmlspecialchars($horaire['heure_ouverture']) . ' - ' . htmlspecialchars($horaire['heure_fermeture']) . '</span>';
                            echo '</li>';
                        }
                        ...
                        // En cas d'erreur PDO, afficher un message d'erreur générique
                        echo "Erreur PDO : " . $e->getMessage();
                    } catch (Exception $e) {
                        // En cas d'autre erreur, afficher un message d'erreur générique
