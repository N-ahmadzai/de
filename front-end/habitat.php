      ...
      <div class="navbar-nav ms-auto">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu rounded-0 rounded-bottom m-0">
            <a href="habitat.php" class="dropdown-item active">Nos habitats</a>
        ...
        <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-6">
                ...
                <h1 class="display-5 mb-0">
                    Voyons nos <span class="text-primary">Superbes Habitats</span>
                </h1>
            </div>
            <div class="col-lg-6 text-lg-end">
                <a class="btn btn-primary py-3 px-5" href="details_habitat.php">Explorer plus d'animaux</a>
            </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        <?php if ($habitat['image_url']): ?>
                            <img src="<?php echo htmlspecialchars('../back-end/admin/' . $habitat['image_url']); ?>" class="card-img-top" alt="Image de l'habitat">
                        <?php endif; ?>
                        <div class="card-body">
                            <h5 class="card-title"><?php echo htmlspecialchars($habitat['name']); ?></h5>
                            <p class="card-text habitat-description"><?php echo htmlspecialchars(truncateText($habitat['description'])); ?></p>
                            <a href="details_habitat.php?id=<?php echo $habitat['id']; ?>" class="btn btn-outline-primary btn-sm">Voir plus</a>
                            <a href="#" class="btn btn-link read-more-link" data-description="<?php echo htmlspecialchars($habitat['description']); ?>">Lire la suite</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
